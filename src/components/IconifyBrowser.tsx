...
export const IconifyBrowser: React.FC<IconifyBrowserProps> = ({ 
  ...
  const handleCustomIconSubmit = (e: React.FormEvent) => {
    ...
    if (!svgContent.trim()) {
      alert('Please enter SVG content');
      return;
    }
    ...
    const newIcon: ExtractedIcon = {
      ...
      name: iconName || `custom-icon-${Date.now()}`,
      category: category || '',
    ...
    <div className="space-y-6">
      ...
      {uploadedFiles.length === 0 ? (
        ...
        <>
          ...
          {showCustomForm && (
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-medium text-slate-800">Add Custom Icon</h3>
              <form onSubmit={handleCustomIconSubmit}>
                <div className="mb-4">
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    SVG Content
                  </label>
                ...
                <div className="flex justify-end">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-white text-slate-600 rounded-lg hover:bg-slate-100 ml-2"
                  >
                    Cancel
                  </button>
                </div>
